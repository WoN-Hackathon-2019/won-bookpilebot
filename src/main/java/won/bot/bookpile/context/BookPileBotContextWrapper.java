package won.bot.bookpile.context;
...
public class BookPileBotContextWrapper extends ServiceAtomEnabledBotContextWrapper {
    private final String connectedSocketsMap;

    public BookPileBotContextWrapper(BotContext botContext, String botName) {
